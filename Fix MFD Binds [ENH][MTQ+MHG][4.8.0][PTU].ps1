...
.EXAMPLE
    .\Fix MFD Binds [ENH][MTQ+MHG][4.8.0][PTU].ps1
    Auto-detect channels, prompt to pick.

.EXAMPLE
    .\Fix MFD Binds [ENH][MTQ+MHG][4.8.0][PTU].ps1 -Channel PTU

.EXAMPLE
    .\Fix MFD Binds [ENH][MTQ+MHG][4.8.0][PTU].ps1 -InstallRoot 'D:\Games\StarCitizen' -Channel PTU
#>
[CmdletBinding()]
param(
...
if (-not (Test-Path -LiteralPath $InstallRoot)) {
    ...
    Write-Host "  .\Fix MFD Binds [ENH][MTQ+MHG][4.8.0][PTU].ps1 -InstallRoot 'X:\path\to\StarCitizen'" -ForegroundColor Yellow
    exit 1
}
